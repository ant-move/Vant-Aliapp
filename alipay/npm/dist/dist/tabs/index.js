...
VantComponent({
  ...
  methods: {
    ...
    resize(skipTransition = false) {
      ...
      Promise.all([getAllRect.call(this, ".van-tab"), getRect.call(this, ".van-tabs__line")]).then(([rects = [], lineRect]) => {
    ...
    scrollIntoView() {
      ...
      Promise.all([getAllRect.call(this, ".van-tab"), getRect.call(this, ".van-tabs__nav")]).then(([tabRects, navRect]) => {
