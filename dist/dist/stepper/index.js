...
(0, _component.VantComponent)((_VantComponent = {
  field: true,
...
}, _defineProperty(_VantComponent, "data", {
  focus: false
}), _defineProperty(_VantComponent, "created", function created() {
  this.set({
    value: this.range(this.data.value)
  });
}), _defineProperty(_VantComponent, "methods", {
