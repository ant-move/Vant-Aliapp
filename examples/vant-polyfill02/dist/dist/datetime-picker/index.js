    ...
    methods: {
        ...
        updateColumns: function updateColumns() {
            var _this$data$formatter = this.data.formatter,
                formatter =
                    _this$data$formatter === void 0
                        ? defaultFormatter
                        : _this$data$formatter;
        ...
        getBoundary: function getBoundary(type, innerValue) {
            ...
            return (
                (_ref2 = {}),
                _defineProperty(_ref2, "".concat(type, "Year"), year),
                _defineProperty(_ref2, "".concat(type, "Month"), month),
                _defineProperty(_ref2, "".concat(type, "Date"), date),
                _defineProperty(_ref2, "".concat(type, "Hour"), hour),
                _defineProperty(_ref2, "".concat(type, "Minute"), minute),
                _ref2
            );
        },
        ...
        onChange: function onChange() {
            ...
            if (data.type === "time") {
                ...
                value = ""
                    .concat(indexes[0] + data.minHour, ":")
                    .concat(indexes[1] + data.minMinute);
            } else {
        ...
        updateColumnValue: function updateColumnValue(value) {
            ...
            var _this$data = this.data,
                ...
                formatter =
                    _this$data$formatter2 === void 0
                        ? defaultFormatter
                        : _this$data$formatter2;
            var picker = this.getPicker();
