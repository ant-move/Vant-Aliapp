...
(0, _component.VantComponent)({
    ...
    computed: {
        ...
        wrapperStyle: function wrapperStyle() {
            var data = this.data;
            return [
                "transition: ".concat(data.duration, "ms"),
                "transform: translate3d(0, ".concat(
                    data.offset + data.baseOffset,
                    "px, 0)"
                ),
                "line-height: ".concat(data.itemHeight, "px")
            ].join("; ");
        }
    },
    watch: {
    ...
    methods: {
        ...
        getOptionText: function getOptionText(option) {
            var data = this.data;
            return (0, _utils.isObj)(option) && data.valueKey in option
