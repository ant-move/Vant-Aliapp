...
module.exports = {
    processTransformationApp: function processTransformationApp(
        _opts,
        options
    ) {
        ...
        _opts.onLaunch = function(res) {
            ...
            function pre() {
                var params =
                    arguments.length > 0 && arguments[0] !== undefined
                        ? arguments[0]
                        : {};
                return utils.defineGetter(params, body.params, function(
                    obj,
                    prop
                ) {
                    warnLife(
                        "onLaunch's return value is not support ".concat(
                            prop,
                            " attribute!"
                        ),
                        "onLaunch/".concat(prop)
                    );
                });
            }
            ...
            if (options.onPageNotFound) {
                warnLife(
                    "There is no onPageNotFound life cycle",
                    "onPageNotFound"
                );
            }
        ...
        _opts.onShow = function(res) {
            ...
            function pre() {
                ...
                return utils.defineGetter(params, body.params, function(
                    ...
                    warnLife(
                        "onShow's return value is not support ".concat(
                            prop,
                            " attribute!"
                        ),
                        "onShow/".concat(prop)
