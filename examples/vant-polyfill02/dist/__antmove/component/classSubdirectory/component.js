...
function updateData(param) {
    ...
    if (_typeof(ctx.properties) === "object") {
        ...
        Object.keys(ctx.properties).forEach(function(item) {
            ...
            if (
                ctx.props[item] !== undefined &&
                typeof ctx.props[item] !== "function" &&
                item[0] !== "$" &&
                ctx.data[item] !== ctx.props[item]
            ) {
...
function handleRelations() {
    ...
    if (this.props.theRelations) {
        Object.keys(this.props.theRelations).forEach(function(relation) {
            ...
            if (
                relationInfo.type === "child" ||
                relationInfo.type === "descendant"
            ) {
                return false;
            }
...
function behaviorsAssign(_opts, item, res) {
    ...
    if (_opts[res]) {
        obj = Object.assign.apply(
            Object,
            [_opts[res]].concat(_toConsumableArray(item[res]))
        );
    } else {
        obj = item[res];
    }
...
function observerHandle(observerObj, args, that) {
    ...
    Object.keys(observerObj).forEach(function(obs) {
        ...
        if (
            args[0][obs] !== that.props[obs] &&
            typeof observerObj[obs] === "function"
        ) {
...
function observersHandle(observersObj, args, that) {
    Object.keys(observersObj).forEach(function(obs) {
        if (
            typeof observersObj[obs].fn === "function" &&
            args[1][obs] !== that.data[obs]
        ) {
            var _observersObj$obs$fn;

            (_observersObj$obs$fn = observersObj[obs].fn).call.apply(
                _observersObj$obs$fn,
                [that].concat(_toConsumableArray(observersObj[obs].arr))
            );
        }
    });
}
...
module.exports = {
    processTransformationComponent: function processTransformationComponent(
        _opts,
        options
    ) {
        ...
        var didMount = function didMount() {
            ...
            var relationAst = createNode.call(
                this,
                null,
                null,
                null,
...
function handleProps() {
    ...
    Object.keys(opts.properties).forEach(function(prop) {
        ...
        if (typeof val === "function") {
            ...
            var obj =
                ((_obj = {}),
                _defineProperty(_obj, Boolean, false),
                _defineProperty(_obj, String, ""),
                _defineProperty(_obj, Array, []),
                _defineProperty(_obj, Object, {}),
                _obj);
        ...
        if (val.hasOwnProperty("value")) {
            ...
            var info =
                ((_info = {}),
                _defineProperty(_info, String, ""),
                _defineProperty(_info, Number, 0),
                _defineProperty(_info, Object, {}),
                _defineProperty(_info, null, null),
                _info);
...
function handleExternalClasses() {
    ...
    function _transform() {
        ...
        str = str.replace(/-(\w)/g, function() {
            for (
                var _len3 = arguments.length, $ = new Array(_len3), _key3 = 0;
                _key3 < _len3;
                _key3++
            ) {
