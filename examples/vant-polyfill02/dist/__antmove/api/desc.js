            ...
            params: {
                props: {
                    advertisData: {
                        type: 3,
                        desc:
                            "当前蓝牙设备的广播数据段中的 ManufacturerData 数据段。wx: ArrayBuffer, alipay: Hex String"
                    }
                }
            },
            returnValue: {
            ...
            params: {
                props: {
                    services: {
                        type: 1,
                        desc:
                            "蓝牙设备主 service 的 uuid 列表, wx: services, alipay: deviceId"
                    }
                }
            }
        }
            ...
            returnValue: {
                props: {
                    advertisData: {
                        type: 3,
                        desc:
                            "设备的广播内容, wx: ArrayBuffer, alipay: Hex String"
                    },
                    advertisServiceUUIDs: {
                        type: 0,
                        desc: "当前蓝牙设备的广播数据段中的ServiceUUIDs 数据段"
            ...
            returnValue: {
                props: {
                    networkType: {
                        type: 1,
                        desc:
                            "wx: wifi/2g/3g/4g/unknown/none, alipay: WIFI/2G/3G/4G/UNKNOWN/NOTREACHABLE"
                    }
                }
            }
        }
            ...
            params: {
                props: {
                    onlyFromCamera: {
                        type: 1,
                        desc:
                            "是否只能从相机扫码，不允许从相册选择图片, wx: onlyFromCamera, alipay: hideAlbum"
                    },
                    scanType: {
                        type: 1,
                        desc:
                            "扫码类型, wx: scanType 支持数组类型；默认值是['barCode', 'qrCode']；取值范围：barCode、qrCode、datamatrix、pdf417, alipay: type 不支持数组类型；默认值是qr；取值范围：qr、bar"
                    }
                }
            },
            returnValue: {
            ...
            returnValue: {
                props: {
                    ...
                    error返回值差异: {
                        type: 3,
                        desc:
                            "app未授权定位：alipay返回错误码11, wx返回errMsg：'getLocation:fail 1', app授权，小程序弹框询问权限时拒绝：alipay返回错误码2001；wx返回errMsg: “getLocation:fail authorize no response”"
                    }
                }
            }
        }
            ...
            params: {
                props: {
                    header: {
                        type: 1,
                        desc:
                            "设置请求的 header，header 中不能设置 Referer。content-type 默认为 application/json, wx: header, alipay: headers"
                    },
                    responseType: {
                        type: 0,
            ...
            returnValue: {
                props: {
                    tempFilePath: {
                        type: 1,
                        desc:
                            "临时文件路径, wx: tempFilePath, alipay: apFilePath"
                    },
                    filePath: {
                        type: 0,
                        desc:
            ...
            params: {
                props: {
                    name: {
                        type: 1,
                        desc:
                            "文件对应的 key，开发者在服务端可以通过这个 key 获取文件的二进制内容, wx: name, alipay: fileName"
                    }
                }
            },
            returnValue: {
                ...
                returnValue: {
                    props: {
                        cardList: {
                            type: 1,
                            desc:
                                "wx: cardList Array.<Object>, alipay: result Object"
                        }
                    }
                }
            }
            ...
            params: {
                props: {
                    confirmText: {
                        type: 1,
                        desc:
                            "确认按钮的文字，最多 4 个字符, wx: confirmText, alipay: confirmButtonText"
                    },
                    cancelText: {
                        type: 1,
                        desc:
                            "取消按钮的文字，最多 4 个字符, wx: cancelText, alipay: cancelButtonText"
                    },
                    showCancel: {
                        type: 0,
                        desc: "是否显示取消按钮"
            ...
            returnValue: {
                props: {
                    confirm: {
                        type: 1,
                        desc:
                            "wx: 为true时，表示用户点击了确定按钮, alipay: 点击confirm返回true，点击cancel返回false"
                    },
                    cancel: {
                        type: 1,
                        desc:
                            "wx: 为 true 时，表示用户点击了取消（用于 Android 系统区分点击蒙层关闭还是点击取消按钮关闭）"
                    }
                }
            }
        }
            ...
            params: {
                props: {
                    itemList: {
                        type: 1,
                        desc:
                            "按钮的文字数组, wx: itemList(数组长度最大为6), alipay: items"
                    },
                    itemColor: {
                        type: 0,
                        desc: "按钮的文字颜色"
