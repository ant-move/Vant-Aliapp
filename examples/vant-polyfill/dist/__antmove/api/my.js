...
var apiObj = {
        ...
        fn: function fn() {
            var obj =
                arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : {};
            var startBeaconDiscoveryParams =
                descObj.startBeaconDiscovery.body.params;
            var params = utils.defineGetter(
                obj,
                startBeaconDiscoveryParams,
                function(obj, prop) {
                    utils.warn(
                        "startBeaconDiscovery\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                            prop,
                            " \u5C5E\u6027!"
                        ),
                        {
    ...
    onBluetoothDeviceFound: {
        fn: function fn(cb) {
            var onBluetoothDeviceFoundProps =
                descObj.onBluetoothDeviceFound.body.returnValue.props;
            my.onBluetoothDeviceFound(function(res) {
                var arr = res.devices.map(function(item) {
                    ...
                    return utils.defineGetter(
                        item,
                        onBluetoothDeviceFoundProps,
                        function(obj, prop) {
                            utils.warn(
                                "onBluetoothDeviceFound\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                                    prop,
                                    " \u5C5E\u6027!"
                                ),
                                {
                                    apiName: "onBluetoothDeviceFound/".concat(
                                        prop
                                    ),
                                    errorType:
                                        onBluetoothDeviceFoundProps[prop].type,
                                    type: "api"
                                }
                            );
                        }
        ...
        fn: function fn() {
            var obj =
                arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : {};
            var getBluetoothDevicesProps =
                descObj.getBluetoothDevices.body.returnValue.props.devices
                    .props;
            my.getBluetoothDevices(
                _objectSpread({}, obj, {
                    success: function success(res) {
                        var arr = res.devices.map(function(item) {
                            item.advertisData = utils.changeType(
                                item.advertisData
                            );
                            return utils.defineGetter(
                                item,
                                getBluetoothDevicesProps,
                                function(obj, prop) {
                                    utils.warn(
                                        "getBluetoothDevices\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                                            prop,
                                            " \u5C5E\u6027!"
                                        ),
                                        {
                                            apiName: "getBluetoothDevices/".concat(
                                                prop
                                            ),
                                            errorType:
                                                getBluetoothDevicesProps[prop]
                                                    .type,
                                            type: "api"
                                        }
                                    );
    ...
    scanCode: {
        fn: function fn() {
            ...
            my.scan(
                _objectSpread({}, obj, {
                    success: function success(res) {
                        var _res = utils.defineGetter(
                            res,
                            scanCodeSuccessRes,
                            function(obj, prop) {
                                utils.warn(
                                    "scanCode\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                                        prop,
                                        " \u5C5E\u6027!"
                                    ),
                                    {
    ...
    stopGyroscope: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, stopGyroscopeParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "stopGyroscope\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    onCompassChange: {
        fn: function fn(cb) {
            var onCompassChangeReturnValue =
                descObj.onCompassChange.body.returnValue;
            my.onCompassChange(function(res) {
                var _res = utils.defineGetter(
                    res,
                    onCompassChangeReturnValue,
                    function(obj, prop) {
                        utils.warn(
                            "onCompassChange\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                                prop,
                                " \u5C5E\u6027!"
                            ),
                            {
                                ...
                                errorType:
                                    onCompassChangeReturnValue[prop].type,
                                type: "api"
                            }
                        );
                    }
    ...
    stopCompass: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, stopCompassParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "stopCompass\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    stopAccelerometer: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(
                ...
                function(obj, prop) {
                    utils.warn(
                        "stopAccelerometer\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                            prop,
                            " \u5C5E\u6027!"
                        ),
                        {
    ...
    makePhoneCall: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, makePhoneCallParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "makePhoneCall\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    getSystemInfoSync: {
        fn: function fn() {
            ...
            var getSystemInfoSyncProps =
                descObj.getSystemInfoSync.body.returnValue.props;
            return utils.defineGetter(ret, getSystemInfoSyncProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "getSystemInfoSync\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
        ...
        fn: function fn() {
            var obj =
                arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : {};
            var getSystemInfoProps =
                descObj.getSystemInfo.body.returnValue.props;
            my.getSystemInfo(
                _objectSpread({}, obj, {
                    success: function success(res) {
    ...
    showToast: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, showToastProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "showToast\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    showModal: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, showModalProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "showModal\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    showLoading: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, showLoadingProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "showLoading\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
        ...
        fn: function fn() {
            var obj =
                arguments.length > 0 && arguments[0] !== undefined
                    ? arguments[0]
                    : {};
            var showActionSheetProps =
                descObj.showActionSheet.body.params.props;
            ...
            var params = utils.defineGetter(obj, showActionSheetProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "showActionSheet\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    pageScrollTo: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, pageScrollToParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "pageScrollTo\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    createMapContext: {
        fn: function fn() {
            ...
            return utils.defineGetter(data, createMapContextProps, function(
                obj,
                prop
            ) {
                utils.warn(
                    "createMapContext\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    openCard: {
        fn: function fn(obj) {
            ...
            var params = utils.defineGetter(obj, openCardParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "openCard\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    downloadFile: {
        fn: function fn() {
            ...
            return utils.defineGetter(task, downloadFileReturnValue, function(
                obj,
                prop
            ) {
                utils.warn(
                    "downloadFile\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    uploadFile: {
        fn: function fn() {
            ...
            return utils.defineGetter(task, uploadFileValue, function(
                obj,
                prop
            ) {
                utils.warn(
                    "uploadFile\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    connectSocket: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, connectSocketParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "connectSocket\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    closeSocket: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, closeSocketParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "closeSocket\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    getRecorderManager: {
        fn: function fn() {
            ...
            return utils.defineGetter(
                ...
                function(obj, prop) {
                    utils.warn(
                        "getRecorderManager\u7684\u8FD4\u56DE\u503C\u4E0D\u652F\u6301 ".concat(
                            prop,
                            " \u5C5E\u6027!"
                        ),
                        {
        ...
        fn: function fn(obj) {
            ...
            if (obj.withCredentials || obj.lang) {
                utils.warn(
                    ...
                    {
                        apiName:
                            "getUserInfo/withCredentials 或 getUserInfo/lang",
                        errorType: 0,
                        type: "api"
                    }
                );
                    ...
                    my.getAuthUserInfo(
                        _objectSpread({}, obj, {
                            success: function success(res) {
                                utils.defineGetter(
                                    res,
                                    getUserInfoSuccessRes,
                                    function(obj, prop) {
                                        utils.warn(
                                            "getUserInfo\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                                                prop,
                                                " \u5C5E\u6027!"
                                            ),
                                            {
                                                apiName: "getUserInfo/".concat(
                                                    prop
                                                ),
                                                errorType:
                                                    getUserInfoSuccessRes[prop]
                                                        .type,
                                                type: "api"
                                            }
                                        );
    ...
    requestPayment: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, requestPaymentParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "requestPayment\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    authorize: {
        fn: function fn() {
            ...
            var params = utils.defineGetter(obj, authorizeParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "authorize\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    addCard: {
        fn: function fn(obj) {
            ...
            var params = utils.defineGetter(obj, addCardParams, function(
                obj,
                prop
            ) {
                utils.warn(
                    "addCard\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                        prop,
                        " \u5C5E\u6027!"
                    ),
                    {
    ...
    startSoterAuthentication: {
        fn: function fn(obj) {
            var startSoterAuthenticationParams =
                descObj.startSoterAuthentication.body.params;
            var params = utils.defineGetter(
                obj,
                startSoterAuthenticationParams,
                function(obj, prop) {
                    utils.warn(
                        "startSoterAuthentication\u7684\u53C2\u6570\u4E0D\u652F\u6301 ".concat(
                            prop,
                            " \u5C5E\u6027!"
                        ),
                        {
                            apiName: prop,
                            errorType:
                                startSoterAuthenticationParams[prop].type,
                            type: "api"
                        }
                    );
                }
